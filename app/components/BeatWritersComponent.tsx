...
export default function BeatWritersComponent() {
    return (
        <section className="container mx-auto px-4 py-16">
            ...
            {/* Stats Bar */}
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-12 p-6 bg- rounded-2xl bg-gradient-to-b from-gray-900 to-gray-800">
                <div className="text-center">
                    <div className="text-2xl md:text-3xl font-bold text-red-800">32</div>
                    <div className="text-sm text-white">NFL Teams</div>
                </div>
                <div className="text-center">
                    <div className="text-2xl md:text-3xl font-bold text-red-800">100+</div>
                    <div className="text-sm text-white">Writers</div>
                </div>
                <div className="text-center">
            ...
            <div className="grid lg:grid-cols-3 gap-8 mb-12">
                ...
                <div className="lg:col-span-1 space-y-6">
                    <div className="bg-gradient-to-br from-red-700 to-red-900 text-white p-8 rounded-2xl">
                    ...
                    <div className="border border-border rounded-2xl p-6 hover:shadow-lg transition-shadow bg-gradient-to-br from-red-700 to-red-900">
                        <div className="w-12 h-12 bg-white/20 rounded-xl flex items-center justify-center mb-4">
                            <Award className="h-6 w-6 text-white" />
                        </div>
                        <h3 className="text-xl text-white font-bold mb-3">Why Trust Our Network?</h3>
                ...
                <div className="lg:col-span-2">
                    <div className="flex items-center justify-between mb-6">
                        <h3 className="text-3xl font-bold">Featured Writers</h3>
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-1 xl:grid-cols-2 gap-6 ">
                        {featuredWriters.map((writer) => (
                            <div key={writer.id} className="group border-2 rounded-xl p-6 hover:shadow-lg transition-all duration-300 bg-card">
                    ...
                    {/* Call to Action Card */}
                    <div className="mt-6 shadow-md border-3 p-8 rounded-2xl bg-card">
                        ...
                        <Link href="/beat-writers">
                            <button className="bg-red-800 text-white hover:scale-102 px-6 py-3 rounded-lg font-semibold transition-colors flex items-center gap-2">
