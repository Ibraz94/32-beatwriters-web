  ...
  return (
    <section className="container mx-auto mt-16 px-4">
      <div className="text-center mb-12">
        <h1 className="text-6xl font-bold mb-6 text-gray-900">NFL Beat Writers</h1>
        ...
        <div className="mt-6 flex justify-center">
          <div className="bg-blue-100 px-6 py-3 rounded-full">
            <span className="text-blue-800 font-semibold">{writers.length} Beat Writers</span>
          </div>
        </div>
      </div>
              ...
              <div className="p-6">
                <div className="flex items-center mb-4">
                  <div className="flex-1">
                    <p className="text-blue-600 font-medium text-sm mb-1">{writer.twitter}</p>
                  ...
                  <div className="text-right">
                    <p className="text-lg font-bold text-gray-900">{writer.followers}</p>
      ...
      <div className="mt-16 text-center">
        <div className="bg-gray-50 rounded-lg p-8 max-w-2xl mx-auto">
          <h3 className="text-2xl font-bold text-gray-900 mb-4">Know a Great Beat Writer?</h3>
